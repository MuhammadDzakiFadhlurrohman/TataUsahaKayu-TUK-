...
$cekNoPetak42=mysqli_query($connect, "SELECT NoPetak FROM pengukuran42 WHERE NoPetak='$NoPetak'");
if (mysqli_num_rows($cekNoPetak42)>0) {
...
$query=mysqli_query($connect, "INSERT INTO pengukuran42 VALUES ('','$NoPetak','$Kontraktor_Harvesting','NoSPK_Harvesting','$Tanggal_Ukur','$Jenis_Kayu', '$NoBatang','$Diameter','$Panjang','$m3, 2','$Nama_Scaler','$Nama_Pengawas')");
if ($query) {
    echo '<script>
