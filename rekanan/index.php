    ...
    <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    <li><a href="../users/index.html" class="font-weight-bolder"><i class="fa fa-handshake-o"></i>&nbsp;Rekanan&nbsp;</a></li>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="InputForm" action="rekananproses.php" method="post">
                            <div class="container">
                                <div class="form-group row">
                                    <div class="col-md-4">Nama Kontraktor</div>
                                    <div class="col-md-1">:</div>
                                    <div class="col-md">
                                        <input type="text" name="Nama_Kontraktor" class="form-control" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-1">:</div>
                                    <div class="col-md">
                                        <select id="Jenis_Badan_Usaha" name="Jenis_Badan_Usaha" class="form-control" >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md">
                                        <label>
                                            <input type="radio" name="Jenis_Pekerjaan" value="HR"> Harvesting
                                        </label>
                                        &nbsp;&nbsp;
                                        <label>
                                            <input type="radio" name="Jenis_Pekerjaan" value="HL"> Hauling
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-1">:</div>
                                    <div class="col-md">
                                        <select id="jenis_kayu" name="Jenis_Kayu" class="form-control" >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-1">:</div>
                                    <div class="col-md">
                                        <input type="text" name="NoAlat_Angkut" class="form-control" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-1">:</div>
                                    <div class="col-md">
                                        <input type="text" name="NoPBPH" class="form-control" >
                                    </div>
                                </div>
                                <div class="form-group row">
