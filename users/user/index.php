...
include "../../assets/sidebar/user.php";
?>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    <li><a href="index.php" class="font-weight-bolder"><i class="fa fa-table"></i>&nbsp;User&nbsp;</a></li>
                    ...
                    <div class="col-md col-sm col-xs-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title d-inline">User List</h4>
                                ...
                                <table id="UserList" class="table table-bordered display table-hover" style="width:100%" >
                                    <thead>
                                        <tr class="text-small">
                                            ...
                                            <th style="max-width: 100px">Otorisasi</th>
                                    ...
                                    while($row = mysqli_fetch_array($query,MYSQLI_ASSOC)) 
                                    {
                                        ...
                                        <tr class="text-center text-small">
                                            ...
                                            <td>
                                            <a href="h.php?id=<?=$row['Username'];?>"class="btn btn-danger btn-sm" role="button" title="Hapus"><i class="fa fa-trash"></i> Hapus</a>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="InputForm" action="../../users/user/registrasiproses.php" method="POST">
                                    <div class="container">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md">
                                                <select name="Jabatan" class="form-control" required>
                                                    ...
                                                    <option value="planning">Staff Planning</option>
                                                    <option value="harvesting">Staff Harvesting</option>
                                                    <option value="tuk">Staff TUK</option>
                                                </select>
                                            </div>
                                        </div>
