    ...
    <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    <li><a href="scaler.php" class="font-weight-bolder"><i class="fa fa-table"></i>&nbsp;User&nbsp;</a></li>
                                ...
                                <table id="UserList" class="table table-bordered display table-hover" style="width:100%" >
                                    ...
                                    while($row = mysqli_fetch_array($query,MYSQLI_ASSOC)) 
                                    {
                                        ...
                                        <tr class="text-center text-small">
                                            ...
                                            <td><?php echo $row['Jenis_Scaler'];?></td>
                                            <td><?php echo $row['NIK_Scaler'];?></td>
                                            <td><?php echo $row['Nama_Scaler'];?></td>
                                            <td>
                                            <a href="h.php?id=<?=$row['NIK_Scaler'];?>"class="btn btn-danger btn-sm" role="button" title="Hapus"><i class="fa fa-trash"></i> Hapus</a>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                        </tr>
                                ...
                                <form id="InputForm" action="../../users/scaler/scalerproses.php" method="POST">
                                    <div class="container">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md">
                                                <select id="Jenis_Scaler" name="Jenis_Scaler" class="form-control" >
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-1">:</div>
                                            <div class="col-md">
                                                <input type="text" name="NIK_Scaler" class="form-control" placeholder="NIK" data-validate="text is required">
                                            </div>
                                        </div>
                                        <div class="form-group row">
